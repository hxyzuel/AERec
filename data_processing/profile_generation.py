...
user_save_path = f'data/portrait/{dataset_name}/user_portrait.json'
item_save_path = f'data/portrait/{dataset_name}/item_portrait.json'

user_test_save_path = f'data/portrait/{dataset_name}/user_portrait_test.json'
item_test_save_path = f'data/portrait/{dataset_name}/item_portrait_test.json'
...
for mode in ['user']:  # ['user', 'item']:
    path = user_path if mode == 'user' else item_path
    keys, hist_list, n, tail = load_data(path, split_num=100)
    print(n, tail)
    # item 85 21
    # user 46 84
