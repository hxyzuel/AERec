...
def config_parser() -> ArgumentParser:
    ...
    parser.add_argument('--text_dims', type=int, default=0)
    parser.add_argument('--mlp_dims', type=int, default=0)
    ...
    parser.add_argument('--dataset_name', type=str, default='video_games',
                        choices=["gowalla", "yelp2020", "amazon-book","video_games"],
    ...
    parser.add_argument("--anchor_weight", type=float, default=0.5,
                        help="anchor assignment weight in metis")
