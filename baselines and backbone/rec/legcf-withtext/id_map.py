...
with open('data/video_games/userHistory_Video_Games.json', 'r') as json_f:
...
with open('data/video_games/user_list.txt', 'w') as file:
    file.write('org_id remap_id\n')
    for user in user_id_map.items():
        file.write(f'{user[0]} {user[1]}\n')

with open('data/video_games/item_list.txt', 'w') as file:
    file.write('org_id remap_id\n')
...
with open('data/video_games/total_interaction.txt', 'w') as file_total:
    with open('data/video_games/train.txt', 'w') as file_train:
        with open('data/video_games/test.txt', 'w') as file_test:
